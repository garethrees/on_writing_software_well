...
class Recordings::LocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'show lock when a recording has been locked by someone else' do
  ...
  test 'show correct lock when a recording has been locked by self' do
    ...
    assert_select 'h1', text: /Looks like you already started editing this document./
  end
  ...
  test 'unlock and redirect to edit' do
    ...
    delete bucket_recording_lock_url(recording.bucket, recording)
  ...
  test 'unlock and redirect to show' do
    ...
    delete bucket_recording_lock_url(recording.bucket, recording, return_to: 'show')
    assert_redirected_to recordable_url(recording)
