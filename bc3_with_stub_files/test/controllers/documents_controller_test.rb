...
class DocumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'editing an active document' do
    ...
    assert_response :ok
    assert_breadcrumbs "Docs & Files > Introduction"
  end

  test 'editing a draft document' do
  end

  test 'updating a document' do
    recording = recordings(:planning_document)

    put bucket_document_url(recording.bucket, recording), params: {
    }
  end
end
